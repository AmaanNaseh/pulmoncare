...
import PredictCT from "./pages/PredictCT";
import PredictHP from "./pages/PredictHP";
import PredictMRI from "./pages/PredictMRI";
import PredictQA from "./pages/PredictQA";
