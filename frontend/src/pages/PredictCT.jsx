...
const PredictCT = () => {
  ...
  const [displayImage, setDisplayImage] = useState("/CT_Healthy.jpg");
  ...
  const handlePost = async () => {
    ...
    try {
      const result = await axios.post(`${ml_backend_url}/predict/ct`, formData);
        ...
        <div className="w-[300px] h-[300px] border-[2px] border-white relative p-2">
          <img
            ...
            className={`w-full h-full ${
              displayImage === "/CT_Healthy.jpg" ? "opacity-75" : ""
            }`}
          />
          {displayImage === "/CT_Healthy.jpg" ? (
